local Movesets = {
    Yuji = {
        {Name="Cursed Strikes", Type="Melee", Range=8, Damage=14, Stun=0.32, Knockback=18, Cooldown=0.45, Tag="CursedStrikes"},
        {Name="Divergent Fist", Type="Melee", Range=8, Damage=18, Stun=0.44, Knockback=30, Cooldown=0.7, Tag="DivergentFist"},
    ...
    Gojo = {
        ...
        {Name="Reversal Red", Type="Burst", Radius=13, Damage=23, Stun=0.55, Knockback=82, Cooldown=2.4, Tag="Red"},
    ...
    Sukuna = {
        {Name="Dismantle", Type="Projectile", Range=22, Damage=17, Stun=0.35, Knockback=28, Cooldown=0.95, Tag="Dismantle"},
        {Name="Cleave", Type="Area", Radius=10, Damage=22, Stun=0.45, Knockback=36, Cooldown=1.5, Tag="Cleave"},
    ...
    Megumi = {
        {Name="Divine Dogs", Type="Melee", Range=11, Damage=16, Stun=0.4, Knockback=34, Cooldown=1.0, Tag="DivineDogs"},
        {Name="Nue", Type="Projectile", Range=24, Damage=20, Stun=0.42, Knockback=48, Cooldown=1.9, Tag="Nue"},
    ...
    Yuta = {
        {Name="Rika Rush", Type="Melee", Range=10, Damage=17, Stun=0.4, Knockback=38, Cooldown=0.9, Tag="RikaRush"},
        {Name="Copy Blade", Type="Melee", Range=11, Damage=22, Stun=0.5, Knockback=46, Cooldown=1.6, Tag="CopyBlade"},
    ...
    Maki = {
        {Name="Katana Rush", Type="Melee", Range=9, Damage=19, Stun=0.42, Knockback=34, Cooldown=0.8, Tag="KatanaRush"},
        {Name="Naginata Sweep", Type="Area", Radius=9, Damage=22, Stun=0.45, Knockback=48, Cooldown=1.8, Tag="NaginataSweep"},
    ...
    Toji = {
        {Name="Split Soul Cut", Type="Melee", Range=10, Damage=24, Stun=0.46, Knockback=44, Cooldown=1.0, Tag="SplitSoulCut"},
        {Name="Inventory Strike", Type="Melee", Range=9, Damage=20, Stun=0.4, Knockback=36, Cooldown=1.2, Tag="InventoryStrike"},
    ...
    Mahito = {
        {Name="Transfigured Palm", Type="Melee", Range=8, Damage=16, Stun=0.55, Knockback=30, Cooldown=1.0, Tag="TransfiguredPalm"},
        {Name="Idle Morph", Type="Mobility", Range=9, Damage=19, Stun=0.45, Knockback=40, Cooldown=1.8, Tag="IdleMorph"},
    ...
    Todo = {
        {Name="Clap Swap", Type="Utility", Range=20, Damage=12, Stun=0.3, Knockback=20, Cooldown=1.0, Tag="ClapSwap"},
        {Name="Boogie Kick", Type="Melee", Range=9, Damage=20, Stun=0.48, Knockback=48, Cooldown=1.2, Tag="BoogieKick"},
    ...
    Hakari = {
        {Name="Pachinko Punch", Type="Melee", Range=9, Damage=17, Stun=0.35, Knockback=28, Cooldown=0.85, Tag="PachinkoPunch"},
        {Name="Private Pure Love", Type="Control", Radius=10, Damage=14, Stun=0.5, Knockback=30, Cooldown=2.0, Tag="PrivatePureLove"},
    ...
    Choso = {
        {Name="Blood Edge", Type="Melee", Range=9, Damage=18, Stun=0.42, Knockback=30, Cooldown=0.9, Tag="BloodEdge"},
        {Name="Piercing Blood", Type="Projectile", Range=30, Damage=25, Stun=0.45, Knockback=68, Cooldown=2.0, Tag="PiercingBlood"},
    ...
    Kashimo = {
        {Name="Lightning Palm", Type="Melee", Range=9, Damage=19, Stun=0.5, Knockback=34, Cooldown=0.8, Tag="LightningPalm"},
        {Name="Staff Break", Type="Melee", Range=11, Damage=24, Stun=0.55, Knockback=48, Cooldown=1.6, Tag="StaffBreak"},
    ...
    Naoya = {
        {Name="Frame Dash", Type="Mobility", Range=12, Damage=15, Stun=0.35, Knockback=30, Cooldown=0.7, Tag="FrameDash"},
        {Name="Projection Rush", Type="Melee", Range=12, Damage=21, Stun=0.42, Knockback=50, Cooldown=1.1, Tag="ProjectionRush"},
    ...
    Kenjaku = {
        {Name="Cursed Spirit Shot", Type="Projectile", Range=23, Damage=18, Stun=0.4, Knockback=40, Cooldown=1.0, Tag="CursedSpiritShot"},
        {Name="Gravity Well", Type="Control", Radius=12, Damage=16, Stun=0.7, Knockback=0, Cooldown=2.8, Tag="GravityWell"},
    ...
    Jogo = {
        {Name="Ember Influx", Type="Projectile", Range=22, Damage=19, Stun=0.38, Knockback=42, Cooldown=0.9, Tag="EmberInflux"},
        {Name="Volcano Punch", Type="Melee", Range=9, Damage=20, Stun=0.46, Knockback=48, Cooldown=1.3, Tag="VolcanoPunch"},
    ...
    Dagon = {
        {Name="Water Shikigami", Type="Melee", Range=10, Damage=16, Stun=0.38, Knockback=34, Cooldown=0.95, Tag="WaterShikigami"},
        {Name="Ocean Pull", Type="Control", Range=18, Damage=15, Stun=0.5, Knockback=0, Cooldown=2.2, Tag="OceanPull", Pull=46},
    ...
    Hanami = {
        {Name="Root Spear", Type="Projectile", Range=20, Damage=20, Stun=0.5, Knockback=42, Cooldown=1.1, Tag="RootSpear"},
        {Name="Bud Burst", Type="Burst", Radius=10, Damage=22, Stun=0.48, Knockback=46, Cooldown=2.0, Tag="BudBurst"},
    ...
    Higuruma = {
        {Name="Gavel Strike", Type="Melee", Range=9, Damage=19, Stun=0.5, Knockback=36, Cooldown=0.95, Tag="GavelStrike"},
        {Name="Judgment Mark", Type="Control", Range=15, Damage=12, Stun=0.85, Knockback=0, Cooldown=2.3, Tag="JudgmentMark"},
    ...
    Takaba = {
        {Name="Joke Punch", Type="Melee", Range=8, Damage=15, Stun=0.4, Knockback=30, Cooldown=0.9, Tag="JokePunch"},
    ...
    Uraume = {
        {Name="Frost Palm", Type="Melee", Range=9, Damage=17, Stun=0.46, Knockback=30, Cooldown=0.9, Tag="FrostPalm"},
        {Name="Ice Formation", Type="Control", Radius=11, Damage=15, Stun=0.65, Knockback=24, Cooldown=2.4, Tag="IceFormation"},
    ...
    Ryu = {
        ...
        {Name="Cursed Burst", Type="Burst", Radius=10, Damage=25, Stun=0.5, Knockback=55, Cooldown=2.1, Tag="CursedBurst"},
    ...
    Uro = {
        {Name="Sky Bend", Type="Control", Range=16, Damage=15, Stun=0.55, Knockback=0, Cooldown=1.4, Tag="SkyBend"},
        {Name="Thin Ice Breaker", Type="Projectile", Range=20, Damage=23, Stun=0.52, Knockback=58, Cooldown=2.2, Tag="ThinIceBreaker"},
