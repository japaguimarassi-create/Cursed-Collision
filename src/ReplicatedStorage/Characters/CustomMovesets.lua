...
function Movesets.Get(id: string, awakened: boolean?): MoveList
    local source = awakened and Awakening[id] or Base[id]
...
function Movesets.GetMove(id: string, slot: number, awakened: boolean?): Move?
    local source = awakened and Awakening[id] or Base[id]
    source = source or Base.Yuji
