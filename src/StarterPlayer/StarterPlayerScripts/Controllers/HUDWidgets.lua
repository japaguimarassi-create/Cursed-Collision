...
function Widgets.Label(parent: Instance, textValue: string, size: UDim2, position: UDim2, textSize: number): TextLabel
...
function Widgets.Button(parent: Instance, name: string, textValue: string): TextButton
    ...
    Widgets.Corner(button, Theme.Radius.Medium)
