...
local WB=require(script.Parent.World.WorldBuilder);local Data=require(script.Parent.Services.PlayerDataService);local World=require(script.Parent.Services.WorldStateService);local Enemy=require(script.Parent.Services.EnemyService);local Quest=require(script.Parent.Services.QuestService);local NPC=require(script.Parent.Services.NPCService);local Combat=require(script.Parent.Services.CombatService);local Economy=require(script.Parent.Services.EconomyService);local Movement=require(script.Parent.Services.MovementService);local Events=require(script.Parent.Services.EventService)
WB.Init();Data.Init();World.Init();Enemy.Init();Combat.Init();Economy.Init(Enemy.Defeated);Quest.Init(Enemy.Defeated);NPC.Init();Movement.Init();Events.Init(Enemy,WB)
